...
@MapperScan(basePackages = "com.zhoushiya.mybatismutidatasource.generator.testdb2",   //注意这里
...
public class SecondaryDataSourceJTAConfig {
    ...
    public SqlSessionFactory secondarySqlSessionFactory(@Qualifier("secondaryDataSource") DataSource dataSource)
        ...
        bean.setTypeAliasesPackage("com.zhoushiya.mybatismutidatasource.generator.testdb2");   //注意这里
